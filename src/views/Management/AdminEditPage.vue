    ...
    <div class="col-md-9">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">{{ $messages.labelManagementEditPage() }}</h4>
        </div>
        <div class="card-body">
          <div class="form-group">
            ...
            <select class="form-control" v-model="role">
              <option
                ...
                v-bind:value="roleOption.id"
                v-bind:key="roleOption.id"
              >
                {{ roleOption.value }}
              </option>
            </select>
          ...
          <div class="form-group">
            ...
            <input
              type="text"
              class="form-control"
              :placeholder="$messages.fieldLabelEnter() + $messages.labelUsername()"
              v-model="utUsername"
            />
          ...
          <div class="form-group">
            ...
            <input
              type="text"
              class="form-control"
              :placeholder="$messages.fieldLabelEnter() + $messages.fieldLabelUserFullname()"
              v-model="utFullname"
            />
          ...
          <div class="form-group">
            <label
              >{{ $messages.fieldLabelPassword() }}</label
            >
            <input
              type="text"
              class="form-control"
              :placeholder="$messages.fieldTooltipEnterWithdrawPasswordIfWantReset()"
              v-model="utPassword"
            />
          ...
          <div class="form-group">
            ...
            <select class="form-control" v-model="utDepartmentId">
              <option
                ...
                v-bind:value="departmentOption.dtId"
  ...
  methods: {
    ...
    async getDetail() {
      const [
        error,
        result,
      ] = await this.$service.managementService.getUserDetail(this.userId);
    ...
    async save() {
      ...
      const [error, result] = await this.$service.managementService.updateUser(
        record
      );
      if (error) {
          loader.hide();
