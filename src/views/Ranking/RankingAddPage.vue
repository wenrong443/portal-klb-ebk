    ...
    <div class="col-md-9">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">{{ $messages.labelRankingAddPage() }}</h4>
        </div>
        <div class="card-body">
          <div class="form-group">
            ...
            <div v-if="v$.drdtType.$error">
              <div v-if="v$.drdtType.required" class="error">
          ...
          <div class="form-group">
            ...
            <div v-if="v$.drdtAmount.$error">
              ...
              <div v-if="v$.drdtAmount.minValue1" class="error">
...
let loader = this.$loading.show({
      ...
      const [error, result] = await this.$service.rankingService.add(record);
loader.hide();
      if (error) {
