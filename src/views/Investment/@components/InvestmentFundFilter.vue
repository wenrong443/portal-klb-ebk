			...
			<div class="card">
				...
				<div class="card-body" v-if="isFilter">
					<div class="form-group">
						<label>{{$messages.fieldLabelPayoutMode()}}</label>
						<select class="form-control" v-model="giptPayoutMode">
					...
					<div class="form-group">
						...
						<select class="form-control" v-model="giptStatus">
...
<script>
import { mixin as RecordMixin } from "../Fund.js";
	...
	computed: {
		...
		sortByOptions() {
			return [
				{
					id: "giptPayoutMode",
					value: this.$messages.fieldLabelPayoutMode(),
				},
				{
					id: "giptStatus",
